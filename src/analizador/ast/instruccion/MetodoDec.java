...
public class MetodoDec extends Instruccion{
    ...
    public MetodoDec(ArrayList<Modificador> modificadores, Tipo tipo, String id, ArrayList<Simbolo> parametros, ArrayList<NodoAst> bloques, int linea, int columna) {
        super(linea, columna);
    ...
    public Object ejecutar(Entorno e, Object salida, ArrayList<ErrorC> errores) {
        if(e.getMetodo(this.id, this.parametros) == null){
            e.add(new Metodo(this.tipo, this.id, this.parametros, this.bloques));
        } else {
